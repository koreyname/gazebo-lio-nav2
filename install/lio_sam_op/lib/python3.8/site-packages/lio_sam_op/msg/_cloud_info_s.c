...
bool lio_sam_op__msg__cloud_info__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("lio_sam_op.msg._cloud_info.CloudInfo", full_classname_dest, 36) == 0);
  }
  lio_sam_op__msg__CloudInfo * ros_message = _ros_message;
  {  // header
...
PyObject * lio_sam_op__msg__cloud_info__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("lio_sam_op.msg._cloud_info");
