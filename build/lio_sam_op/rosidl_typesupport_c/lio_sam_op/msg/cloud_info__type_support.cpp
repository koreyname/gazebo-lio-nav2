...
static const _CloudInfo_type_support_symbol_names_t _CloudInfo_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, lio_sam_op, msg, CloudInfo)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, lio_sam_op, msg, CloudInfo)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, lio_sam_op, msg, CloudInfo)() {
  return &::lio_sam_op::msg::rosidl_typesupport_c::CloudInfo_message_type_support_handle;
}
