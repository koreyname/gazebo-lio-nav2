...
#include <stddef.h>
#include "lio_sam_op/srv/detail/save_map__rosidl_typesupport_introspection_c.h"
#include "lio_sam_op/msg/rosidl_typesupport_introspection_c__visibility_control.h"
...
static rosidl_typesupport_introspection_c__MessageMember SaveMap_Request__rosidl_typesupport_introspection_c__SaveMap_Request_message_member_array[2] = {
  {
    ...
    offsetof(lio_sam_op__srv__SaveMap_Request, resolution),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(lio_sam_op__srv__SaveMap_Request, destination),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers SaveMap_Request__rosidl_typesupport_introspection_c__SaveMap_Request_message_members = {
  "lio_sam_op__srv",  // message namespace
  "SaveMap_Request",  // message name
  2,  // number of fields
  sizeof(lio_sam_op__srv__SaveMap_Request),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_lio_sam_op
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, lio_sam_op, srv, SaveMap_Request)() {
...
static rosidl_typesupport_introspection_c__MessageMember SaveMap_Response__rosidl_typesupport_introspection_c__SaveMap_Response_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(lio_sam_op__srv__SaveMap_Response, success),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers SaveMap_Response__rosidl_typesupport_introspection_c__SaveMap_Response_message_members = {
  ...
  1,  // number of fields
  sizeof(lio_sam_op__srv__SaveMap_Response),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_lio_sam_op
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, lio_sam_op, srv, SaveMap_Response)() {
...
static rosidl_typesupport_introspection_c__ServiceMembers lio_sam_op__srv__detail__save_map__rosidl_typesupport_introspection_c__SaveMap_service_members = {
  "lio_sam_op__srv",  // service namespace
  "SaveMap",  // service name
  // these two fields are initialized below on the first access
  NULL,  // request message
  // lio_sam_op__srv__detail__save_map__rosidl_typesupport_introspection_c__SaveMap_Request_message_type_support_handle,
  NULL  // response message
  // lio_sam_op__srv__detail__save_map__rosidl_typesupport_introspection_c__SaveMap_Response_message_type_support_handle
};

static rosidl_service_type_support_t lio_sam_op__srv__detail__save_map__rosidl_typesupport_introspection_c__SaveMap_service_type_support_handle = {
  0,
  &lio_sam_op__srv__detail__save_map__rosidl_typesupport_introspection_c__SaveMap_service_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, lio_sam_op, srv, SaveMap)() {
  if (!lio_sam_op__srv__detail__save_map__rosidl_typesupport_introspection_c__SaveMap_service_type_support_handle.typesupport_identifier) {
    lio_sam_op__srv__detail__save_map__rosidl_typesupport_introspection_c__SaveMap_service_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  rosidl_typesupport_introspection_c__ServiceMembers * service_members =
    (rosidl_typesupport_introspection_c__ServiceMembers *)lio_sam_op__srv__detail__save_map__rosidl_typesupport_introspection_c__SaveMap_service_type_support_handle.data;

  if (!service_members->request_members_) {
    service_members->request_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, lio_sam_op, srv, SaveMap_Request)()->data;
  }
  if (!service_members->response_members_) {
    service_members->response_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, lio_sam_op, srv, SaveMap_Response)()->data;
  }

  return &lio_sam_op__srv__detail__save_map__rosidl_typesupport_introspection_c__SaveMap_service_type_support_handle;
}
