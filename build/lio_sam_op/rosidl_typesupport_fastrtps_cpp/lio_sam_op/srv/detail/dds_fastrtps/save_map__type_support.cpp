...
#include "lio_sam_op/srv/detail/save_map__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const lio_sam_op::srv::SaveMap_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  lio_sam_op::srv::SaveMap_Request & ros_message)
{
  // Member: resolution
  cdr >> ros_message.resolution;
...
{
  auto typed_message =
    static_cast<const lio_sam_op::srv::SaveMap_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<lio_sam_op::srv::SaveMap_Request *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_lio_sam_op
const rosidl_message_type_support_t *
get_message_type_support_handle<lio_sam_op::srv::SaveMap_Request>()
{
  return &lio_sam_op::srv::typesupport_fastrtps_cpp::_SaveMap_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, lio_sam_op, srv, SaveMap_Request)() {
  return &lio_sam_op::srv::typesupport_fastrtps_cpp::_SaveMap_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_lio_sam_op
cdr_serialize(
  const lio_sam_op::srv::SaveMap_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: success
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  lio_sam_op::srv::SaveMap_Response & ros_message)
{
  // Member: success
  {
    uint8_t tmp;
...
{
  auto typed_message =
    static_cast<const lio_sam_op::srv::SaveMap_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<lio_sam_op::srv::SaveMap_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &lio_sam_op::srv::typesupport_fastrtps_cpp::_SaveMap_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, lio_sam_op, srv, SaveMap_Response)() {
  return &lio_sam_op::srv::typesupport_fastrtps_cpp::_SaveMap_Response__handle;
}
...
{
  return &lio_sam_op::srv::typesupport_fastrtps_cpp::_SaveMap__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, lio_sam_op, srv, SaveMap)() {
  return &lio_sam_op::srv::typesupport_fastrtps_cpp::_SaveMap__handle;
}
