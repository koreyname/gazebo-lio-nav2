...
#include "lio_sam_op/msg/detail/cloud_info__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const lio_sam_op::msg::CloudInfo *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<lio_sam_op::msg::CloudInfo *>(
    untyped_ros_message);
...
{
  return &lio_sam_op::msg::typesupport_fastrtps_cpp::_CloudInfo__handle;
}
