...
: ${AMENT_CURRENT_PREFIX:="/home/korey/Desktop/lio-sam_simulation_navigation/install/robot_navigation2"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/robot_navigation2/environment/pythonpath.sh"
